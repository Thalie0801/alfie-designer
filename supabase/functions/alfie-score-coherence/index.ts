...
serve(async (req) => {
  ...
  try {
    ...
    console.log("[Alfie Score Coherence] Starting analysis", {
      render_url,
      has_brand_spec: !!brand_spec,
    });
    ...
    if (!aiResponse.ok) {
      ...
      console.error(
        "[Alfie Score Coherence] AI Gateway error:",
        aiResponse.status,
        errorText,
      );
    ...
    console.log("[Alfie Score Coherence] AI analysis received", {
    ...
    console.log("[Alfie Score Coherence] Analysis complete", {
      score,
