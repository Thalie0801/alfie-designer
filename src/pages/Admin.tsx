...
import { Users, FileText, DollarSign, Activity, ExternalLink } from 'lucide-react';
          ...
          <TabsContent value="affiliates" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Gérer les partenaires affiliés</CardDescription>
              </CardHeader>
              <CardContent>
                {loading ? (
                  <p className="text-center text-muted-foreground py-4">Chargement...</p>
                ...
                {loading ? (
                  ...
                  <div className="space-y-2">
                    {conversions.map((conversion: any) => (
                      ...
                      >
                        <div>
                          <p className="font-medium">{conversion.affiliate?.name || 'N/A'}</p>
                ...
                {loading ? (
                  ...
                  <div className="space-y-2">
                    {payouts.map((payout: any) => (
                      ...
                      >
                        <div>
                          <p className="font-medium">{payout.affiliate?.name || 'N/A'}</p>
                          <p className="text-sm text-muted-foreground">
