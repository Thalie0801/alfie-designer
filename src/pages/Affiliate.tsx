...
import { Copy, DollarSign, MousePointerClick, TrendingUp } from 'lucide-react';
  ...
  if (!affiliate) {
    return (
      <div className="max-w-2xl mx-auto text-center py-12">
        <h1 className="text-2xl font-bold mb-4">Programme d'affiliation</h1>
        <p className="text-muted-foreground mb-6">
          Votre compte affilié a été créé automatiquement ! Partagez votre lien et gagnez 20% de commission sur chaque vente.
        </p>
        <Button onClick={loadAffiliateData}>Actualiser</Button>
      </div>
    );
  }
