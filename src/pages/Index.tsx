      ...
      <section id="pricing" className="max-w-6xl mx-auto px-3 sm:px-4 py-8 sm:py-14">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5">
          <PriceCard 
            ...
            isAnnual={isAnnual}
            bullets={["1 marque","20 visuels/mois","150 crédits IA/mois","100 requêtes Alfie/mois","Générateur de contenu IA intégré","2 templates"]} 
            cta="Essayer Starter"
          ...
          <PriceCard 
            ...
            isAnnual={isAnnual}
            highlight 
            bullets={["3 marques","100 visuels/mois","375 crédits IA/mois","250 requêtes Alfie/mois","Générateur de contenu IA intégré","-20% sur packs de crédits","4 templates + Reels"]} 
            cta="Choisir Pro"
          ...
          <PriceCard 
            ...
            priceLabel={getPriceLabel()}
            isAnnual={isAnnual}
            bullets={["Multi-marques (5 max)","1000 visuels/mois","750 crédits IA/mois","500 requêtes Alfie/mois","Générateur de contenu IA intégré","-20% sur packs de crédits","Reels avancés","Analytics"]} 
            cta="Passer Studio"
